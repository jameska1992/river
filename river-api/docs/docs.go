...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/api-tokens": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/services.APITokenView"
                            }
                        }
                    }
                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "{name, expires_in_days, scopes}",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.mintAPITokenRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/logs": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by level (info|warn|error)",
                        "name": "level",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/services.ServiceKeyView"
                            }
                        }
                    }
                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.mintServiceKeyRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "{key, service_key}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/admin/service-keys/seed": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "{keys:[{name,key,scopes}]}",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.seedServiceKeysRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/stats": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{movies, tv_shows, tracks, audiobooks}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "integer"
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/handlers.unidentifiedItem"
                            }
                        }
                    },
                    "500": {
        ...
        "/admin/upload": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Used as folder/file name",
                        "name": "title",
                        "in": "formData",
                        "required": true
                    },
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.adminSetPasswordRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/webhooks": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/services.WebhookView"
                            }
                        }
                    }
                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "{name,url,events,enabled}",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/albums": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Album fields",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.albumRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/artists": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Artist fields",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.artistRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.createAudioTrackRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/audiobooks": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "title | author | year | added",
                        "name": "sort",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.Audiobook"
                            }
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Audiobook fields",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.audiobookRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/audiobooks/{id}": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Also delete chapter files from disk",
                        "name": "delete_files",
                        "in": "query"
                    }
                ],
        ...
        "/audiobooks/{id}/chapters": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.AudiobookChapter"
                            }
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Chapter fields",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.chapterRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/audiobooks/{id}/chapters/{chapterId}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Also delete the chapter file from disk",
                        "name": "delete_files",
                        "in": "query"
                    }
                ],
        ...
        "/audiobooks/{id}/chapters/{chapterId}/stream": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/audiobooks/{id}/refresh-metadata": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/auth/login": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "{access_token, refresh_token, stream_token, user}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/auth/refresh": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "{access_token, refresh_token, stream_token}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.createLogReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/movies": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "title | year | rating | added",
                        "name": "sort",
                        "in": "query"
                    },
                    {
        ...
        "/movies/{id}": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Also remove source/transcoded files",
                        "name": "delete_files",
                        "in": "query"
                    }
                ],
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.creditsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/movies/{id}/identify": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "{title?, year?, imdb_id?}",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/progress": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "movie | episode | chapter",
                        "name": "media_type",
                        "in": "query",
                        "required": true
                    },
        ...
        "/progress/ws": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Access JWT (also accepted via Authorization header)",
                        "name": "token",
                        "in": "query"
                    }
                ],
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/handlers.recentItem"
                            }
                        }
                    },
                    "500": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/handlers.MovieSearchResult"
                            }
                        }
                    },
                    "400": {
        ...
        "/request/shows": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/handlers.ShowSearchResult"
                            }
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "{tvdbId, title, year}",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.addShowReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.createSubtitleRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.tvShowRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/tvshows/{id}": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Also remove show folder on disk",
                        "name": "delete_files",
                        "in": "query"
                    }
                ],
        ...
        "/tvshows/{id}/next-episode": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{season_id, episode_id}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/tvshows/{id}/seasons/{seasonId}/episodes": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Episode fields",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.episodeRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/tvshows/{id}/seasons/{seasonId}/episodes/{episodeId}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/tvshows/{id}/seasons/{seasonId}/episodes/{episodeId}/download": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/tvshows/{id}/seasons/{seasonId}/episodes/{episodeId}/re-transcode": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/tvshows/{id}/seasons/{seasonId}/episodes/{episodeId}/source-path": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/tvshows/{id}/seasons/{seasonId}/episodes/{episodeId}/stream": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/tvshows/{id}/seasons/{seasonId}/episodes/{episodeId}/subtitles": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/watchlist": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Media reference",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.watchlistAddRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/models.WatchlistItem"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.watchPartyCreateReq"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/models.WatchParty"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/services.ActiveWebhook"
                            }
                        }
                    }
                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.recordDeliveryRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handlers.adminSetPasswordRequest": {
            "type": "object",
            "required": [
                "password"
            ],
        ...
        "handlers.createSubtitleRequest": {
            "type": "object",
            "required": [
                "file_path",
                "language",
        ...
        "handlers.creditsRequest": {
            "type": "object",
            "properties": {
                "cast": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.castEntryRequest"
                    }
                },
                "crew": {
                    "type": "array",
        ...
        "handlers.mintAPITokenRequest": {
            ...
            "properties": {
                "expires_in_days": {
                    "description": "ExpiresInDays optionally expires the token after N days (0 = never).",
                    "type": "integer"
                },
                "name": {
                    "type": "string"
        ...
        "handlers.mintServiceKeyRequest": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "handlers.recordDeliveryRequest": {
            "type": "object",
            "required": [
                "status",
                "webhook_id"
        ...
        "models.AudioTrack": {
            ...
            "properties": {
                ...
                "file_path": {
                    "description": "variant MP4 (video + this audio only)",
                    "type": "string"
                },
                "id": {
                    "type": "string"
                ...
                "label": {
                    "description": "human-readable e.g. \"English\"",
                    "type": "string"
                },
                "language": {
                    "description": "BCP-47 tag e.g. \"en\"",
                    "type": "string"
                },
                "media_id": {
                    "type": "string"
                ...
                "stream_index": {
                    "description": "0-based audio stream index in the video file",
                    "type": "integer"
                },
                "updated_at": {
                    "type": "string"
        ...
        "models.WatchProgress": {
            ...
            "properties": {
                "completed": {
                    "description": "position/duration \u003e= 0.9",
                    "type": "boolean"
                },
                "created_at": {
                    "type": "string"
        ...
        "models.WebhookDelivery": {
            ...
            "properties": {
                ...
                "event": {
                    "description": "routing key, e.g. \"media.ready.movie\"",
                    "type": "string"
                },
                "id": {
                    "type": "string"
...
var SwaggerInfo = &swag.Spec{
	...
	Schemes:          []string{},
	Title:            "River API",
	Description:      "REST API for the River self-hosted media platform.\nAuth flow: POST /api/auth/login → use the returned\naccess_token as a Bearer token on the protected routes.\nThe stream_token is a longer-lived JWT restricted to\n/stream and /download endpoints (the <video> element\ncan't send custom auth headers; it goes in the URL as\n?token=…).",
